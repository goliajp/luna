...
fn fib_28_compiles_side_trace() {
    ...
    let cl = vm
        ...
        .unwrap();
    let r = vm
        .call_value(luna::runtime::Value::Closure(cl), &[])
        .unwrap();
...
fn walk_any_side_ptr_non_null(
    cl: luna::runtime::heap::Gc<luna::runtime::function::LuaClosure>,
) -> bool {
    fn walk(
        proto: luna::runtime::heap::Gc<luna::runtime::function::Proto>,
    ) -> bool {
