...
// v1.3 Stage 7 follow-on — re-export of the 32 `luna_jit_*` Cranelift
...
pub use luna_jit::jit_backend::{
    ...
    luna_jit_suppress_trace_admit, luna_jit_table_get_field, luna_jit_table_get_float,
    luna_jit_table_get_int, luna_jit_table_get_tagged, luna_jit_table_len,
    ...
    luna_jit_upval_get, luna_jit_upval_get_float, luna_jit_upval_table_get_tagged,
};
...
/// v1.3 Stage 7 follow-on — pull all 32 `luna_jit_*` Cranelift
...
///
/// Returns the number of helper symbols pinned (always 32 with the
/// current `luna-jit` shape; will need to be bumped in lock-step
/// any time `crates/luna-jit/src/jit_backend/mod.rs` adds a 33rd
