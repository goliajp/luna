...
fn recorder_observes_depth_above_zero_on_nested_call() {
    ...
    let r = vm
        ...
        .unwrap();
    assert!(matches!(r[0], luna::runtime::Value::Int(501500)));
...
fn deep_nested_calls_in_hot_loop_trigger_max_inline_depth_close() {
    ...
    assert!(matches!(r[0], luna::runtime::Value::Int(4200)));
    ...
    let max_depth_cap = luna::jit::trace::MAX_INLINE_DEPTH;
    assert!(
